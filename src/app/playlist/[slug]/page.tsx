    ...
    <div style={{ minHeight: "100vh", background: "#FFFFFF", color: "#0F0F0F", fontFamily: "Inter, 'Hiragino Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 32px" }}>
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <h1 style={{ fontSize: "32px", fontWeight: 800, color: "#0F0F0F", letterSpacing: "-0.02em", margin: "0 0 12px" }}>
            {playlist.name}
          </h1>
          <div style={{ display: "flex", alignItems: "center", gap: "16px", fontSize: "13px", color: "#888888" }}>
            {playlist.created_by && (
              <span>by <strong style={{ color: "#606060" }}>{playlist.created_by}</strong></span>
            )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
          {tracks.map((track, i) => (
            ...
            >
              <span style={{ fontSize: "12px", color: "#AAAAAA", width: "20px", textAlign: "right", flexShrink: 0 }}>
                {i + 1}
              </span>
              {track.album.images[0]?.url && (
                <img
                  ...
                  width={44} height={44}
                  style={{ borderRadius: "8px", flexShrink: 0, boxShadow: "0 2px 8px rgba(0,0,0,0.12)" }}
                />
              )}
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ color: "#0F0F0F", fontSize: "14px", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  {track.name}
                </div>
              ...
              <div style={{ display: "flex", gap: "6px", flexShrink: 0 }}>
                {track.bpm && (
                  <span style={{ fontSize: "11px", color: "#606060", background: "#F2F2F2", padding: "2px 7px", borderRadius: "5px", border: "1px solid #E5E5E5" }}>
                    {track.bpm} BPM
                  </span>
                )}
                {track.camelot && (
                  <span style={{ fontSize: "11px", color: "#2250df", background: "#dde8ff", padding: "2px 7px", borderRadius: "5px", fontWeight: 600 }}>
                    {track.camelot}
                  </span>
                )}
              </div>
        ...
        {/* フッター */}
        <div style={{ marginTop: "48px", paddingTop: "24px", borderTop: "1px solid #E5E5E5", textAlign: "center" }}>
          <a
            href={BASE_URL}
            style={{
          ...
          <p style={{ marginTop: "16px", fontSize: "12px", color: "#AAAAAA" }}>
